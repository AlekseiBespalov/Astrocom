...
public class SgtSpacetimeWell_Editor : SgtEditor<SgtSpacetimeWell>
{
	...
	{
        DrawDefault("ObjectToSize");
        BeginError(Any(t => t.Radius < 0.0f));
			DrawDefault("Radius");
		EndError();
        BeginError(Any(t => t.Radius < 0.0f));
            DrawDefault("RadiusOffset");
        EndError();
        DrawDefault("Strength");
        DrawDefault("StrengthOffset");
...
public class SgtSpacetimeWell : MonoBehaviour
{
    ...
    public float StrengthOffset = 1f;
	...
	protected virtual void Update()
	{
        ...
        Strength = ObjectToSize.transform.lossyScale.magnitude * StrengthOffset;

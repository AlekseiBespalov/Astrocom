...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneGenerator : MonoBehaviour
    {
        ...
        public ObjectsCounter objectsCounter;
        ...
        public void CheckObjectsCountForPlanes()
        {
            if (objectsCounter.CurrentCountOfObjects == 0)
            {
                ToggleAllPlanes(true);
            }
            if (objectsCounter.CurrentCountOfObjects != 0 && prefabsMenu.ChosenPrefab == -1)
            {

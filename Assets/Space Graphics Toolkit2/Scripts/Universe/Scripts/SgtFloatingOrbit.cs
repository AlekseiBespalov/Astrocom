...
namespace SpaceGraphicsToolkit2
{
	...
	public class SgtFloatingOrbit_Editor : SgtEditor<SgtFloatingOrbit>
	{
		protected override void OnInspector()
		{
            ...
            DrawDefault("RadiusOffset", "The radius to change orbit size");
            DrawDefault("ObjectToSize", "Object to scale trajectory");
...
namespace SpaceGraphicsToolkit2
{
	...
	{
        public GameObject ObjectToSize;
        public double RadiusOffset = 1f;
